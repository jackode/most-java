package chapter21.concurrency;//: concurrency/MapComparisons.java
// {Args: 1 10 10} (Fast verification check during build)
// Rough comparison of thread-safe Map performance.
import chapter07.net.mindview.util.CountingGenerator;
import chapter07.net.mindview.util.MapData;
